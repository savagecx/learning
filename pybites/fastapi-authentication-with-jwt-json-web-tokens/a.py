...
SECRET_KEY = "963456d8424a9e506d82d1947774c56a2fa3cf1099315cd93e07f44dc5eea21a"  # noqa S105
ALGORITHM = "HS256"
...
async def get_foods_for_user(
    ...
    return [food_entry for food_entry in food_log.values() if food_entry.user.id == current_user.id]
